var mizhu = new function() {
	...
	this.confirm = function(title, message, selected) {
		...
		var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3></h3></div><div class="body-panel"><p class="content"></p><p class="btns"><div class="w-btn" tabindex="1" onclick="mizhu._close(false);">取消</div><div class="w-btn w-btn-border" onclick="mizhu._close(true);">确定</div></p></div></div></div>';
	...
	this.alert = function(title, message, ico) {
		...
		var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3></h3></div><div class="body-panel">' + icon + '<p class="content"></p><p class="btns"><div class="w-btn w-btn-ok" tabindex="1" onclick="mizhu.close();">确定</div></p></div></div></div>';
		messageBox(html, title, message);
	}
